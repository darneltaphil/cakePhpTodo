...
class TodosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'scheduled_time' => ['type' => 'time', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'scheduled_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'scheduled_time' => '15:25:16',
                'scheduled_date' => '2021-12-23',
                'status' => 'Lorem ipsum dolor sit amet',
                'created_at' => '2021-12-23 15:25:16',
            ],
        ];
        parent::init();
    }
